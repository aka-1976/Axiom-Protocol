...
- **Halving interval**: Every 2,100,000 blocks (~4 years per era)
...
- **Generation duration**: ~4 years per halving era
- **Total eras**: 33 halvings until reward reaches negligible amounts
- **Supply curve**: 100% mined after ~33 eras (around year 33)
...
- **Window**: 60 blocks (~60 hours)
- **Max adjustment**: 3x per adjustment period
- **VDF Time-Lock**: 3600 seconds (mandatory)
